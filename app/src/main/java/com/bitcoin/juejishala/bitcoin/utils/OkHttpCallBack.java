...
public abstract class OkHttpCallBack<T> {
    ...
    public static abstract class CallBackDefault extends OkHttpCallBack<Response> {
        @Override
    ...
    public static abstract class CallBackString extends OkHttpCallBack<String> {
        @Override
    ...
    public static abstract class CallBackBitmap extends OkHttpCallBack<Bitmap> {
     ...
     * 下载文件时的回调类
     */
    public static abstract class CallBackFile extends OkHttpCallBack<File> {
